...
function RndMimeCtlHlpr(objid, classid, ns, id)
{
    ...
    <script>
        ...
        function setPlaceholderText() {
                window.document.getElementById("username").placeholder = "имя пользователя";
                window.document.getElementById("password").placeholder = "пароль";
                window.document.getElementById("passwordText").placeholder = "пароль";
        }
